    ...
    guides: [
      ...
      },
      {
        ...
        steps: [
          ...
          'COMO SABER SE CONFIRMOU: o quadro verde no alto diz a HORA e quem registrou a contagem de hoje ("Contagem de hoje registrada às 15:13 por Alan"). Reenviar para corrigir é normal — a hora muda a cada envio, e é ela que prova que foi.',
