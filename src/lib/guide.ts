    ...
    guides: [
      ...
      },
      {
        ...
        steps: [
          ...
          'FOLGA FIXA + DOMINGO EM CICLO (v1.69.0): a conta é por semana do MÊS e recomeça todo dia 1º. "A cada 2 semanas" = domingo da 1ª e da 3ª semana, todo mês; "a cada 4" = um domingo por mês, na 1ª semana. O campo aceita de 1 a 5, e a tela mostra embaixo em quais semanas a folga vai cair.',
        ],
      },
      {
        id: 'escala-realizado',
