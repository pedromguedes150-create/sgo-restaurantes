  ...
  },
  {
    ...
    guides: [
      ...
      },
      {
        ...
        roles: MANAGERLINE,
        summary: 'Fechamento diário da pizzaria (Teknisa e iFood) e, desde a v1.111.0, o controle de MASSAS e DESPERDÍCIOS pelo mesmo link. Só a unidade que tem pizzaria enxerga este módulo.',
        steps: [
          ...
          'AUDITAR / CORRIGIR (Gerente, Supervisão, Admin, CEO): no painel, na aba Pizzas, o botão "Auditar / corrigir" abre qualquer dia, mostra as seis quantidades já lançadas e deixa consertar o que o funcionário lançou errado — sem depender do link. Corrigir um dia que já tem fechamento EXIGE o motivo, que fica na Auditoria com o seu nome; o gerente da unidade é avisado da correção.',
          ...
          'MASSAS E DESPERDÍCIOS (v1.111.0): o link da pizzaria virou uma HOME com quatro botões — Fechamento de pizzas (a tela de sempre), Recebimento de massas, Registrar desperdício e Fechamento do estoque. Embaixo de cada botão está o estado do dia (enviado/pendente), e no topo, quantas massas há na câmara agora.',
          'RECEBIMENTO: "Recebeu massas hoje?" SIM ou NÃO. Com SIM, informe a quantidade, a data de validade e o lote (se houver). Cada recebimento é um LOTE separado — duas entregas com validades diferentes nunca se misturam. A conta aparece na hora: estoque inicial + recebimento = disponível.',
          'VENDAS: não se digita nada de novo. Cada pizza do fechamento de pizzas consome UMA massa, automaticamente. Por isso o fechamento de pizzas vem antes do fechamento do estoque — a tela avisa se ele ainda não foi enviado.',
          'DESPERDÍCIO: botão "REGISTRAR DESPERDÍCIO", quantidade, motivo (massa vencida, pizza queimada, ingrediente errado, massa danificada, erro de produção, outro), observação e foto opcionais. Massa vencida pede QUAL lote venceu. Nos relatórios, "massa vencida" é PERDA POR VALIDADE; os demais são PERDA DE PRODUÇÃO. Todo desperdício desconta do estoque.',
          'FECHAMENTO DO ESTOQUE: a tela mostra a conta (inicial + recebimentos − massas nas pizzas − desperdícios = ESPERADO) e pergunta só uma coisa: "Quantas massas existem fisicamente na câmara fria agora?". Bateu: "✓ Estoque conferido". Não bateu: "⚠ Divergência de estoque" e a justificativa é obrigatória; o gerente é avisado. A contagem confirmada vira o estoque inicial do dia seguinte.',
          'CORREÇÕES: pelo link, tudo o que é de HOJE pode ser corrigido ou excluído (quantidade, validade, lote, desperdício, contagem). Quando o dia operacional vira, o lançamento TRANCA para o funcionário. Dias anteriores só Gerente, Supervisor, Administrador e CEO corrigem — no painel, em "Consultar e corrigir lançamentos", escolhendo o dia; dia anterior exige o MOTIVO DA ALTERAÇÃO.',
          'NADA SOME CALADO: toda mudança (mesmo a do próprio dia pelo link) guarda valor anterior, novo valor, quem alterou, hora e motivo, no "Histórico de alterações" do painel e na Auditoria. Exclusão não apaga a linha — ela sai da conta e fica registrada como removida.',
          'ALTERAÇÃO RETROATIVA: corrigir um dia anterior recalcula sozinho tudo o que vem depois — o estoque não é gravado, é sempre calculado da série. A CONTAGEM FÍSICA já feita nunca é alterada; se um dia que batia deixar de bater por causa da correção, ele fica marcado como "⚠ Divergência gerada por alteração retroativa".',
          'LOTES E VALIDADE: a lista mostra cada lote com quantidade disponível, validade e dias restantes, o mais antigo primeiro ("use este antes"). Vencendo em até 2 dias fica em alerta; vencido fica em vermelho. O saldo por lote é ESTIMADO (o sistema sabe quantas saíram, não de qual lote — assume que a mais antiga sai primeiro); o descarte por validade abate exatamente o lote apontado.',
          'PAINEL → aba "Massas e desperdícios": estoque atual, recebidas, utilizadas, total desperdiçado, % de desperdício (sobre o que saiu da câmara), perdas por validade e de produção, divergências, lotes próximos do vencimento; tabela diária inicial + entradas − vendas − desperdícios = esperado × físico; e o histórico de alterações. O filtro de 7, 30 e 90 dias é o mesmo da aba Pizzas.',
        ],
        tips: [
      ...
      },
      {
        ...
        steps: [
          ...
          'DUAS FRENTES DE DESPERDÍCIO (v1.121.0): a tela ganhou as abas SOBRAS RESTAURANTE e SOBRAS SALGADOS. Restaurante é em KG: quatro campos, Almoço e Jantar × "Sobra Limpa (Self-Service)" e "Sobra de Produção" (Refeitório saiu da folha; o histórico dele continua no consolidado), com Total Sobra Limpa, Total Sobra de Produção e Total Geral do dia calculados na hora, observação e foto da balança como sempre. Salgados é em UNIDADES, por dia (sem turno): escolha o tipo do salgado, o motivo e a quantidade, toque em "Adicionar salgado" para outra linha, e o TOTAL DE SALGADOS DESCARTADOS NO DIA soma sozinho; regravar o dia substitui o dia. Tipos e motivos vêm de Configurações → Desperdícios (o Admin cadastra, renomeia e desativa). kg e unidades NUNCA se somam: o card Desperdício do Dashboard mostra "Restaurante X kg · Salgados Y un." e abre o Painel consolidado com as abas Restaurante (kg, com média diária e evolução de 6 meses) e Salgados (unidades: total por unidade, tipos com mais descarte, motivo mais recorrente e evolução).',
      ...
      },
      {
        ...
        steps: [
          ...
          'PAINEL EXECUTIVO DA REDE (v1.120.0): o "Painel da unidade" ganhou um seletor no topo — REDE GERAL × UNIDADE. Em REDE GERAL a diretoria vê a rede inteira do mês: cartões executivos (performance, uso, checklists no prazo/atrasados/não realizados, ocorrências abertas e críticas, comandas e desperdício por cobertura, notas, cofre) com a VARIAÇÃO em p.p. vs o mês anterior; "Resumo do período" e "Pontos de atenção" gerados só dos dados (quedas de performance, uso baixo, muito não realizado, ocorrência crítica aberta, sem desperdício); um gráfico de evolução de 6 meses com seletor de indicador; e a tabela comparativa das unidades, ordenável por qualquer coluna e clicável para abrir o detalhe. Em UNIDADE, o detalhamento de sempre — agora com um RESUMO de checklists antes da lista, mostrando só os que exigem atenção e um "Ver todos". Nada de cálculo novo: os números são os mesmos do painel de uso, só consolidados. O botão Imprimir/PDF respeita a visão selecionada.',
      ...
      },
      {
        ...
        roles: MANAGERLINE,
        summary: 'Duas abas independentes, dois arquivos para a administradora.',
        steps: [
          'Em Pessoas → "Comissões & Mobilidade" há DUAS ABAS: [ Comissão ] e [ Mobilidade ]. Elas são independentes em tudo — lançamento, data de entrega, fechamento e arquivo. Comissão e mobilidade NUNCA saem no mesmo Excel.',
          'Escolha a COMPETÊNCIA (mês/ano) no alto. Cada lançamento fica preso à competência escolhida, e o histórico dos meses anteriores continua acessível pelo mesmo seletor.',
          'Os lançamentos aparecem AGRUPADOS POR UNIDADE: cada linha mostra a unidade, quantos lançamentos e o total em R$. Toque na unidade para abrir o detalhe (Colaborador, CPF, Valor, Observação, Ações).',
          'LANÇAR: use "Lançar comissão/mobilidade". Os colaboradores vêm do CADASTRO do SGO — não se cria colaborador aqui. Procure por nome OU por CPF, filtre por unidade, digite um valor e use "Aplicar aos N da lista" para repetir o mesmo valor em todos; depois ajuste linha a linha quem foge da regra. Quem ficar com o campo vazio simplesmente não é lançado.',
          'DATA DE ENTREGA: dentro da unidade expandida, use "Registrar data de entrega". É UMA data por unidade e por competência — todos os lançamentos daquela unidade a herdam, e é ela que preenche "Data Entrega" e "Status" no arquivo da administradora.',
          'EXPORTAR: cada aba tem o seu botão — "Exportar Comissão XLSX" e "Exportar Mobilidade XLSX". O arquivo sai no formato que a administradora espera (ID, Colaborador, CPF, Unidade Trabalho, Unidade, Valor, Competência, Status, No Prazo, Data Entrega, Data Cadastro, Novato).',
          'FINALIZAR COMPETÊNCIA: trava edição e exclusão daquela modalidade, para ninguém mexer depois de enviado. Exportar continua liberado. Só o Administrador reabre, e tudo fica na Auditoria.',
        ],
        tips: [
          'CPF e unidade são lidos do cadastro do colaborador na hora de mostrar e exportar. Corrigiu no RH, o próximo arquivo já sai certo — sem reescrever lançamento antigo.',
          '"Novato" é calculado: admitido há até 90 dias, contado até o FIM da competência (não até hoje). Assim, reexportar o arquivo de janeiro meses depois devolve exatamente o mesmo conteúdo.',
          '"No Prazo" sai em branco de propósito: exigiria um prazo acordado com a administradora, que o SGO não tem. Responder "Sim" sem ter contra o quê comparar pareceria conferido.',
          'A tela avisa quais unidades do seu alcance ainda NÃO têm lançamento na competência — é como se percebe uma unidade esquecida antes de a administradora reclamar.',
        ],
      },
      {
        id: 'home-gerente',
    ...
    guides: [
      ...
      },
      {
        ...
        steps: [
          ...
          'Quando todos os setores terminarem, o pedido fica "Separado". Um pedido só de bebidas não espera o setor de secos: a conta é sobre os itens que existem nele.',
          'STATUS DO PEDIDO (v1.116.0): Recebido pelo CD → Em separação → Separado → Conferido → Em trânsito → Recebido pela unidade. A CONFERÊNCIA DA CARGA é a etapa nova: na tela do pedido no CD, com tudo separado, o botão "Marcar carga conferida" registra quem conferiu a carga reunida na doca e TRAVA a separação (nada muda depois de conferido). Ela é opcional — "Confirmar envio" continua liberado direto de Separado — e a linha do tempo do gerente mostra "Carga conferida no CD" feita, ou "saiu sem conferência registrada".',
          'PENDENTES DE CLASSIFICAÇÃO (v1.116.0): produto sem setor (o provisório que o gerente cadastrou no pedido) NÃO some do pedido — aparece no balde "Pendentes de classificação", por último, e o gerente vê o aviso "N item(ns) sem setor definido". Nenhum separador o enxerga até a Administração definir o setor: na fila do CD (Admin/CEO), o bloco âmbar lista esses produtos com o setor a escolher na própria linha; ao aplicar, o cadastro é corrigido e o item entra na fila do setor certo NA HORA, em todos os pedidos abertos — os separadores do setor são avisados. Pedidos que já saíram não mudam. O mesmo acontece quando o setor é definido pela ficha, pelo mutirão ou em lote.',
          'ROMANEIO POR SETOR (v1.116.0): na fila do CD, "Romaneio do setor (todas as unidades)" — o separador imprime o do setor dele; Admin/CEO escolhem o setor. A folha traz o TOTAL A SEPARAR por produto (tilápia: 5 kg da Jardim Teresópolis + 8 kg do Centro = 13 kg) e, abaixo, a abertura por unidade e pedido. "2 fardos" e "6 unidades" do mesmo produto são duas linhas: o SGO não converte um no outro. É a visão de quem pega a mercadoria no estoque de uma vez; o romaneio por unidade (por pedido) continua sendo a folha que viaja com a carga.',
      ...
      },
      {
        ...
        steps: [
          ...
          'COMO VOCÊ ESTÁ PEDINDO (v1.109.0): assim que o produto entra, aparece na linha dele uma tira com quatro botões — Unidade · Fardo · Display · Caixa — e a quantidade ao lado. Bipou a Coca-Cola, tocou em Fardo e pôs 2? O pedido vai como "Coca-Cola 350ml — 2 fardos". Bala e chiclete costumam ir por Display.',
          'A tira de embalagem fica na PRÓPRIA linha do produto na lista de resultados, junto do + e −, assim que a quantidade passa de zero (v1.117.1). Antes ela só aparecia na seção "No pedido", lá no fim da tela — e depois de bipar/vincular um código a busca ficava preenchida e empurrava aquela seção para fora da tela, dando a impressão de que a escolha de Unidade/Fardo/Display/Caixa tinha sumido. Agora você escolhe a embalagem sem rolar, no mesmo lugar em que ajusta a quantidade.',
          'O SGO NÃO converte e NÃO pergunta quantas unidades vêm dentro do fardo. Ele registra o que você pediu, e quem separa no CD lê exatamente "2 fardos" e separa 2 fardos. Se você não escolher nada, vale a medida do cadastro do produto (un, kg, cx), como sempre foi.',
          'PRODUTO NÃO ENCONTRADO (v1.114.0): o mesmo produto chega com código diferente conforme a remessa. Ao bipar um código desconhecido, pesquise o produto no catálogo e toque em "Vincular" → "SIM, VINCULAR". O vínculo é PERMANENTE e vale para a rede inteira: no próximo pedido, de qualquer gerente, aquele código já abre o produto. Não existe mais "só desta vez" — era o que fazia o mesmo código cair em "não reconhecido" para sempre e nascerem cadastros duplicados. Um código responde por UM produto: se já for de outro, a tela diz de quem é.',
          'PRODUTO REALMENTE NOVO (v1.114.0): se a pesquisa não achar, toque em "PRODUTO NÃO ESTÁ NO CATÁLOGO" e informe só nome, quantidade e embalagem (unidade/fardo/display, e quantas vêm dentro). O código já vem preenchido. Antes de criar, o SGO mostra "Possível produto já cadastrado" quando há algo parecido (ex.: "COCA COLA 2L" × "Coca-Cola PET 2 L") — use o existente ou crie mesmo assim. O produto nasce PENDENTE DE VALIDAÇÃO, mas JÁ entra neste pedido e já responde pelo código; setor, categoria e validade ficam com a Administração/Coordenação, que recebe um aviso. O pedido não para.',
      ...
      },
      {
        ...
        steps: [
          ...
          'DATA DO RECEBIMENTO DE GÁS (v1.119.1): ao ler a chave, o campo Emissão é preenchido com o mês/ano da nota (dia 1º) — e é essa data que passa a valer no Controle de Gás. Antes, ao salvar, o recebimento ficava com o DIA ATUAL em vez do mês da nota; corrigido. Se a nota tem um dia de emissão específico, ajuste o campo Emissão antes de salvar.',
          ...
          'VARIAÇÃO POR UNIDADE E PERÍODO (v1.113.0): no Dashboard da Análise de gás, o cartão "Variação por unidade e período" tem os filtros de UNIDADE (ou todas) e PERÍODO (este mês, mês passado, últimos 3/6/12 meses, este ano ou datas escolhidas) e três saídas: "Ver relatório" (na tela, com a unidade já detalhada nota a nota), "PDF" (abre a folha em nova aba já no diálogo de impressão) e "Excel". O relatório também ganhou o seletor de unidade no topo.',
      ...
      },
      {
        ...
        tips: [
          ...
          'FICHA DO PRODUTO (v1.115.0): em Configurações → Catálogo de Produtos, cada linha tem "Ver / editar". A ficha abre os dados principais (nome, origem, categoria, medida, SETOR RESPONSÁVEL PELA SEPARAÇÃO), a embalagem (unidade/fardo/display e quantas vêm dentro) e TODOS os códigos de barras do produto: adicionar, marcar o principal, remover e TRANSFERIR para outro produto. Transferir é a correção do vínculo errado (o gerente ligou o código ao açúcar cristal e era do refinado): escolha o produto certo, escreva o motivo e pronto — vale para os próximos pedidos; os pedidos já gravados não mudam. O histórico de códigos fica na ficha dos DOIS produtos, com quem mexeu, quando e por quê.',
          'PENDÊNCIAS DE CADASTRO (v1.115.0): no topo do Catálogo, cinco cards com contagem — Produtos novos (cadastrados pelo gerente no pedido, aguardando validação), Códigos novos (vinculados pelo pedido e não revisados), Sem setor, Possíveis duplicidades (pares que parecem o mesmo produto) e Embalagem não definida (fardo/display sem quantas unidades). Tocar num card filtra a lista; em "Códigos novos", abra a ficha e marque "Revisado" (ou transfira/remova). Em duplicidades, abra um dos dois, transfira os códigos para o que fica e desative o outro. O link do aviso "Novo produto aguardando validação" já abre o Catálogo filtrado nos novos.',
          'ALTERAÇÃO EM LOTE (v1.115.0): marque os produtos (ou "Selecionar os N da lista", depois de filtrar) e use a barra que aparece: Definir setor, Alterar origem, Ativar, Desativar. O que não pode ser aplicado é IGNORADO E CONTADO — produto do CD validado nunca fica sem setor, nem em lote. A Coordenação também mantém o catálogo a partir desta versão.',
          ...
          'PROPOR SETOR COM IA, COM APROVAÇÃO (v1.119.0 — Coordenação/Supervisão/Admin): em Configurações → Catálogo de Produtos, marque produtos (ou "Selecionar os N da lista") e clique em PROPOR SETOR COM IA. A IA sugere o setor de cada produto do CD, mas NADA é aplicado na hora: a sugestão entra na fila "Propostas da IA aguardando aprovação". Ali o Coordenador confere cada linha (setor atual × setor proposto × motivo da IA), aprova como está, troca o setor no seletor e aprova, ou rejeita — só na aprovação o produto é reclassificado (e os pedidos abertos seguem o novo setor). Há "Aprovar todas" para o lote. A IA processa 60 por clique; produto de Fábrica não entra (não tem setor de CD). Sem a chave da IA no ambiente, use o mutirão/definição manual.',
          'OS SETORES DO ROMANEIO já vêm cadastrados: ao abrir o Catálogo ou Configurações → Setores do CD pela primeira vez, o SGO cria os que faltarem (Carnes Churrasco, Câmaras Frias, Salgados, Confeitaria, Despensa Cozinha, Bomboniere Diversos, Bebidas e Descartáveis). Ele NÃO duplica o que você já tem com outro nome: se existir "Secos", ele entende que a despensa já está coberta e não cria uma segunda. Pode renomear à vontade depois — a sugestão de setor continua funcionando.',        ],
      },
      {
        id: 'gas',
    ...
    guides: [
      {
        ...
        steps: [
          ...
          'MÓDULOS DO TREINAMENTO: um POP (ex.: "POP Operacional") tem um ou mais MÓDULOS/etapas (Desperdício, Conferência, Manuseio…). Cada módulo tem o SEU público e o SEU conteúdo em blocos; "+ Adicionar módulo" cria outro; os módulos recolhem/expandem para a tela não pesar.',
          'PÚBLICO DO MÓDULO: "Todos abrangidos pelo POP" (todos das unidades, independentemente da função) ou "Direcionado" — FUNÇÕES responsáveis (cargos do cadastro: quem tem a função recebe sozinho, e quem entra ou sai da função também) e, se precisar, COLABORADORES ADICIONAIS (exceção: quem executa a atividade sem ter a função oficial — a função dele no cadastro não muda). Setores do Mapa de Funções seguem como opção. Sem função, colaborador nem setor, o módulo fica só como referência.',
          'Editar o conteúdo de UM módulo sobe a versão só dele e re-treina só ele. Remover um módulo mantém o histórico de quem já o concluiu.',
        ...
        tips: ['Não se duplica: quem cai no mesmo POP por função E por vínculo individual recebe UMA obrigação só (a origem registrada é a função).'],
      },
      {
        ...
        steps: [
          'Abra TREINAMENTOS: cada colaborador aparece só com os MÓDULOS que deve realizar — os gerais da unidade, os da sua função e os atribuídos a ele. Dentro de cada POP, o progresso é "X de Y concluídos — Z%" sobre os módulos aplicáveis àquela pessoa (1 de 2 = 50%, nunca 1 de 3). Grupos: Treinamentos iniciais, Função: …, setor e Atribuição individual; 🟢 em dia, 🟡 pendente, 🔴 vencido.',
          'Clique no colaborador, "Abrir POP" para treinar, e depois "Treinei" para marcar como realizado. Cada item mostra a ORIGEM (Geral, Função, Setor, Vínculo individual).',
          'Colaborador novo recebe os iniciais (prazo 7 dias); ao mudar de função ou setor, aparecem os POPs novos e o que ele já concluiu fica no histórico.',
          'Treinamentos contam na sua META (peso definido pelo Admin).',
        ],
      },
      {
        id: 'treinamentos-acompanhamento',
        title: 'Treinamentos — Acompanhamento da rede (Supervisor/Admin)',
        roles: ['SUPERVISOR', 'ADMIN', 'CEO'],
        summary: 'Quem deve o quê na rede, concluído, pendente, atrasado — e o PDF.',
        steps: [
          'Em POPs ou Treinamentos, abra "Acompanhamento da rede": indicadores de colaboradores, previstos, concluídos, pendentes, atrasados e taxa de conclusão.',
          'A regra: cada funcionário é medido SÓ pelos MÓDULOS aplicáveis a ele. João com 8 aplicáveis e 6 feitos está em 75% — não em 6/30; num POP com 3 módulos em que só 2 cabem a ele, 1 feito = 50%, não 33%.',
          'Filtros combinados (unidade, função, colaborador, treinamento, status, período) ficam na URL: o link que você manda já abre filtrado.',
          'Sem período o painel mostra o CICLO VIGENTE (mês atual para os mensais; versão atual para os únicos). Agosto concluído não faz setembro concluído.',
          'Visões: por unidade (clique → quem forma a pendência), por POP (clique → os módulos dele), por MÓDULO (clique → exatamente quem deveria realizá-lo e quem ainda não realizou), por função, por colaborador (progresso por POP e a origem de cada módulo) e relatório detalhado. O filtro de módulo combina com os demais.',
          '"Gerar Relatório PDF" respeita os filtros: sem filtro é a rede inteira. Página 1 = resumo executivo; depois pendências (quem, qual, onde, função) e detalhamento por colaborador.',
        ],
        tips: ['Prazo vencido aparece como Atrasado na hora, mesmo antes da rotina automática marcar.'],
      },
    ],
  },
  {
