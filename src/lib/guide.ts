    ...
    guides: [
      {
        ...
        steps: [
          ...
          'PÚBLICO DO TREINAMENTO: "Geral / Inicial" (todos das unidades escolhidas, independentemente da função) ou "Direcionado".',
          'Direcionado: escolha as FUNÇÕES (cargos do cadastro — quem tem a função recebe sozinho, e quem entra ou sai da função também) e, se precisar, COLABORADORES ADICIONAIS (exceção: quem executa a atividade sem ter a função oficial — a função dele no cadastro não muda).',
          'Setores do Mapa de Funções continuam disponíveis (regra anterior, opcional). Sem função, colaborador nem setor, o POP fica só como referência.',
      ...
      },
      {
        ...
        steps: [
          'Abra TREINAMENTOS: cada colaborador aparece só com o que deve realizar — os gerais da unidade, os da sua função e os atribuídos a ele. Grupos: Treinamentos iniciais, Função: …, setor e Atribuição individual; 🟢 em dia, 🟡 pendente, 🔴 vencido.',
      ...
      },
      {
        ...
        steps: [
          ...
          'A regra: cada funcionário é medido SÓ pelos treinamentos aplicáveis a ele. João com 8 aplicáveis e 6 feitos está em 75% — não em 6/30.',
          ...
          'Visões: por unidade (clique → quem forma a pendência), por treinamento (clique → quem ainda não fez), por função, por colaborador (histórico com a origem de cada atribuição) e relatório detalhado.',
