  ...
  return (
    <div className="mx-auto max-w-3xl space-y-4 print:max-w-none">
      <div className="flex items-center justify-between gap-2 print:hidden">
        <Link href={`/modulos/comandas/analise-aberto?unit=${a.unitId}`} className="inline-flex items-center gap-1 text-sm font-semibold text-brand"><ArrowLeft className="h-4 w-4" /> Voltar</Link>
        <PrintButton label="Imprimir / PDF" />
      </div>

      <div className="rounded-lg border p-4 print:border-0 print:p-0">
        <div className="mb-3 border-b pb-2">
          <h1 className="text-lg font-bold text-ink-900">Comandas em aberto — Monitoramento</h1>
