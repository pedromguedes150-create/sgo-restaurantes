  ...
  return (
    <div className="space-y-4">
      ...
      <Card><CardContent className="pt-4">
        <TemplatesAdmin
          units={units}
          templates={templates.map((t) => ({ id: t.id, unitId: t.unitId, name: t.name, limitTime: t.limitTime, weight: t.weight, module: t.module, requiresEvidence: t.requiresEvidence, entersMeta: t.entersMeta, active: t.active }))}
        />
      </CardContent></Card>
    </div>
  );
