...
export async function POST(req: Request) {
  ...
  else if (b.action === 'catUpsert') r = await upsertProduct(user, { id: b.id ? String(b.id) : undefined, name: String(b.name ?? ''), origin: String(b.origin ?? ''), category: b.category, measure: b.measure });
